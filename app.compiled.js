  ...
  <div style="border-top:1px solid ${REPORT_COLORS.border};margin-top:28px;padding-top:14px;display:flex;justify-content:space-between;align-items:center;">
    ...
    <div style="font-size:10px;color:${REPORT_COLORS.textMuted};">Generated ${dt} \xB7 CONFIDENTIAL</div>
      ...
      var NAV = [
        ...
        { id: "pullplan", icon: "??", label: "Pull Plan Board" },
        ...
        { id: "linedesign", icon: "??", label: "Line Designation Chart" },
        { divider: "PROCUREMENT" },
      ...
      function App() {
        ...
        const [pullPlan, setPullPlan] = usePersist("pullPlan", []);
        const [pullPlanLanes, setPullPlanLanes] = usePersist("pullPlanLanes", ["Mechanical", "Electrical", "Plumbing"]);
        const [linedesign, setLinedesign2] = usePersist("linedesign", []);
        ...
        }, onCancel: close }), modal === "jsa" && /* @__PURE__ */ React.createElement(JSAForm, { iS, lS, S, projects, initial: editTgt, onSave: (d) => saveRec(setJsas, d), onCancel: close }), ["safetyinsp", "safetyobs", "safetyforms", "qualityinsp", "qualityobs", "qualityforms", "projdocs", "projdir", "projspecs", "projforms", "drawings", "changeorders", "purchaseorders", "meetings", "pullplan", "linedesign"].includes(modal) && /* @__PURE__ */ React.createElement(SForm, { iS, S, projects, initial: editTgt, tab: modal, onSave: (d) => {
          const m = { safetyinsp: setSafetyInsp, safetyobs: setSafetyObs, safetyforms: setSafetyForms, qualityinsp: setQualityInsp, qualityobs: setQualityObs, qualityforms: setQualityForms, projdocs: setProjDocs, projdir: setProjDir, projspecs: setProjSpecs, projforms: setProjForms, drawings: setDrawings, changeorders: setChangeOrders, purchaseorders: setPurchaseOrders, meetings: setMeetings, pullplan: setPullPlan, linedesign: setLinedesign2 };
      ...
      var SCFG = {
        ...
        linedesign: { icon: "??", label: "Line Designation Chart", color: "#8B5CF6", csv: ["projectId", "lineNumber", "service", "size", "material", "insulation", "opTemp", "opPressure", "designTemp", "designPressure", "testPressure", "fromTo", "drawingRef", "pidRef", "notes"], cols: [{ k: "lineNumber", l: "LINE #" }, { k: "service", l: "SERVICE" }, { k: "size", l: "SIZE" }, { k: "material", l: "MATERIAL/SPEC" }, { k: "opTemp", l: "OP TEMP" }, { k: "opPressure", l: "OP PRESS" }, { k: "designTemp", l: "DESIGN TEMP" }, { k: "designPressure", l: "DESIGN PRESS" }, { k: "testPressure", l: "TEST PRESS" }, { k: "drawingRef", l: "DWG REF" }], fields: [{ k: "lineNumber", l: "LINE NUMBER", t: "text", ph: "e.g. CHW-101-4in", f: false }, { k: "service", l: "SERVICE / FLUID", t: "text", ph: "e.g. Chilled Water Supply", f: false }, { k: "size", l: "SIZE", t: "text", ph: "e.g. 4 inch", f: false }, { k: "material", l: "MATERIAL / SPEC", t: "text", ph: "e.g. Sch 40 Carbon Steel", f: false }, { k: "insulation", l: "INSULATION TYPE & THICKNESS", t: "text", ph: "e.g. 1.5in Fiberglass", f: false }, { k: "opTemp", l: "OPERATING TEMP", t: "text", ph: "e.g. 44F", f: false }, { k: "opPressure", l: "OPERATING PRESSURE", t: "text", ph: "e.g. 60 PSI", f: false }, { k: "designTemp", l: "DESIGN TEMP", t: "text", ph: "e.g. 250F", f: false }, { k: "designPressure", l: "DESIGN PRESSURE", t: "text", ph: "e.g. 150 PSI", f: false }, { k: "testPressure", l: "TEST PRESSURE", t: "text", ph: "e.g. 225 PSI", f: false }, { k: "fromTo", l: "FROM / TO", t: "text", ph: "e.g. AHU-1 to Coil Header", f: false }, { k: "drawingRef", l: "DRAWING REFERENCE", t: "text", ph: "e.g. M-301", f: false }, { k: "pidRef", l: "P&ID REFERENCE", t: "text", ph: "e.g. P-101", f: false }, { k: "notes", l: "NOTES", t: "ta", rows: 2, f: true }] },
        ...
        pullplan: { icon: "??", label: "Pull Plan Board", color: "#06B6D4", csv: ["projectId", "activity", "trade", "weekOf", "plannedStart", "plannedFinish", "actualFinish", "predecessor", "constraint", "status", "notes"], cols: [{ k: "activity", l: "ACTIVITY" }, { k: "trade", l: "TRADE" }, { k: "weekOf", l: "WEEK OF" }, { k: "plannedStart", l: "PLANNED START" }, { k: "plannedFinish", l: "PLANNED FINISH" }, { k: "constraint", l: "CONSTRAINT" }, { k: "status", l: "STATUS" }], fields: [{ k: "activity", l: "ACTIVITY", t: "text", ph: "e.g. Set rough-in piping - Level 3", f: true }, { k: "trade", l: "RESPONSIBLE TRADE / COMPANY", t: "text", ph: "e.g. ABC Mechanical", f: false }, { k: "weekOf", l: "WEEK OF", t: "date", f: false }, { k: "plannedStart", l: "PLANNED START", t: "date", f: false }, { k: "plannedFinish", l: "PLANNED FINISH", t: "date", f: false }, { k: "actualFinish", l: "ACTUAL FINISH", t: "date", f: false }, { k: "predecessor", l: "PREDECESSOR (DEPENDS ON)", t: "text", ph: "What must happen first", f: true }, { k: "constraint", l: "CONSTRAINT", t: "sel", opts: ["None", "Material", "RFI / Information", "Manpower", "Equipment", "Prior Trade", "Permit / Inspection", "Design", "Other"], f: false }, { k: "status", l: "STATUS", t: "sel", opts: ["Planned", "In Progress", "Complete", "Behind Schedule", "Blocked"], f: false }, { k: "notes", l: "NOTES", t: "ta", rows: 3, f: true }] }
      };
      function PullPlanBoard({ data, lanes, setLanes, filt, openAdd, openEdit, setData, S, darkMode, pN, showToast }) {
        ...
        base.setDate(base.getDate() + wkOff * 7);
        ...
        function cardsFor(lane, day) {
          return rows.filter(function(r) {
            return r.trade === lane && r.plannedStart === iso(day);
          });
        }
        function addLane() {
          const n = window.prompt("New trade/company name:");
          if (n && n.trim()) setLanes(function(l) {
            return [...l, n.trim()];
          });
        }
        function renameLane(old) {
          const n = window.prompt("Rename lane:", old);
          if (n && n.trim() && n.trim() !== old) {
            setLanes(function(l) {
              return l.map(function(x) {
                return x === old ? n.trim() : x;
              });
            });
            setData(function(d) {
              return d.map(function(r) {
                return r.trade === old ? { ...r, trade: n.trim() } : r;
              });
            });
          }
        }
        function delLane(name) {
          if (window.confirm('Remove lane "' + name + '"? Existing cards keep their data but the lane row disappears.')) setLanes(function(l) {
            return l.filter(function(x) {
              return x !== name;
            });
          });
        }
        const palette = ["c-blue", "c-amber", "c-teal", "c-coral", "c-pink", "c-purple", "c-green"];
        ...
        return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700 } }, "Pull Plan Board"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, ...S.text3, background: dark ? "#1a1f2e" : "#f1f5f9", padding: "3px 10px", borderRadius: 8 } }, "Week of ", fmtD(days[0]))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("button", { onClick: function() {
        ...
        }, style: S.btnS }, "Prev"), /* @__PURE__ */ React.createElement("button", { onClick: function() {
          setWkOff(0);
        }, style: S.btnS }, "Today"), /* @__PURE__ */ React.createElement("button", { onClick: function() {
          setWkOff(function(w) {
            return w + 1;
          });
          ...
          return /* @__PURE__ */ React.createElement(React.Fragment, { key: lane }, /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 12px", fontSize: 12, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, borderBottom: li < lanes.length - 1 ? bd : "none", borderRight: bd } }, /* @__PURE__ */ React.createElement("span", { onClick: function() {
            renameLane(lane);
          }, style: { cursor: "pointer" }, title: "Click to rename" }, lane), /* @__PURE__ */ React.createElement("span", { onClick: function() {
            delLane(lane);
          }, style: { cursor: "pointer", color: "#ef4444", fontSize: 13 }, title: "Remove lane" }, "Remove")), days.map(function(d, di) {
            const cs = cardsFor(lane, d);
            return /* @__PURE__ */ React.createElement("div", { key: di, style: { padding: 8, minHeight: 88, borderBottom: li < lanes.length - 1 ? bd : "none", borderRight: di < 4 ? bd : "none", display: "flex", flexDirection: "column", gap: 6 } }, cs.map(function(c) {
              return /* @__PURE__ */ React.createElement("div", { key: c.id, onClick: function() {
                openEdit("pullplan", c);
              }, className: colorFor(lane), style: { borderRadius: 8, padding: "8px 10px", fontSize: 12, cursor: "pointer", borderLeft: c.constraint && c.constraint !== "None" ? "3px solid #ef4444" : "none", opacity: c.status === "Complete" ? 0.55 : 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, textDecoration: c.status === "Complete" ? "line-through" : "none" } }, c.activity), c.constraint && c.constraint !== "None" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, marginTop: 4, background: "rgba(0,0,0,0.08)", display: "inline-block", padding: "1px 6px", borderRadius: 4 } }, c.constraint), c.status === "Complete" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, marginTop: 4 } }, "Complete"));
            }), /* @__PURE__ */ React.createElement("button", { onClick: function() {
              openAdd("pullplan");
            }, style: { border: "1px dashed " + (dark ? "#3a4260" : "#cbd5e1"), background: "transparent", height: cs.length ? 28 : 60, borderRadius: 8, fontSize: 11, ...S.text3, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" } }, "+ Add"));
          }));
        }))));
      }
      function AILineModal({ S, darkMode, projects, selProj, setLinedesign: setLinedesign2, onClose }) {
        ...
        async function run() {
          ...
          try {
            ...
            for (const f of files) {
              ...
              docs.push({ type: "document", source: { type: "base64", media_type: "application/pdf", data: b64 } });
            }
            const sys = "You are extracting a mechanical/plumbing line designation chart from construction drawings, specs, and schedules. Return ONLY a raw JSON array, no markdown, no commentary. Each object must have exactly these keys: lineNumber, service, size, material, insulation, opTemp, opPressure, designTemp, designPressure, testPressure, fromTo, drawingRef, pidRef, notes. Use empty string for any field not found. Do not invent data not present in the documents.";
            const userContent = docs.slice();
            if (pasted.trim()) userContent.push({ type: "text", text: pasted });
            userContent.push({ type: "text", text: "Extract every pipe line shown into the JSON array described." });
            const resp = await fetch("https://claudeproxy-rkvcepcpza-uc.a.run.app", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ model: "claude-sonnet-4-6", max_tokens: 4e3, system: sys, messages: [{ role: "user", content: userContent }] }) });
            const data = await resp.json();
            const text = (data.content || []).map(function(b) {
              return b.text || "";
            }).join("");
            const clean = text.replace(/```json|```/g, "").trim();
            const arr = JSON.parse(clean);
            const withIds = arr.map(function(o) {
              return Object.assign({ id: Math.random().toString(36).slice(2, 9), projectId: selProj }, o);
            });
            setLinedesign2(function(d) {
              return [...d, ...withIds];
            });
            onClose();
          } catch (e) {
        ...
        return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 } }, /* @__PURE__ */ React.createElement("div", { style: { background: dark ? "#11151f" : "#fff", borderRadius: 12, padding: 20, width: 480, maxWidth: "92vw", maxHeight: "85vh", overflowY: "auto" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, marginBottom: 10 } }, "AI Extract Line Designation Chart"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, marginBottom: 10, opacity: 0.7 } }, "Upload drawings, specs, or schedules (PDF), and/or paste text. AI will extract the line list."), /* @__PURE__ */ React.createElement("input", { type: "file", multiple: true, accept: ".pdf", onChange: function(e) {
          setFiles(Array.from(e.target.files));
        }, style: { marginBottom: 10 } }), /* @__PURE__ */ React.createElement("textarea", { value: pasted, onChange: function(e) {
          setPasted(e.target.value);
        }, placeholder: "Or paste line list text here", rows: 5, style: { width: "100%", marginBottom: 10, padding: 8, borderRadius: 8 } }), err && /* @__PURE__ */ React.createElement("div", { style: { color: "#ef4444", fontSize: 12, marginBottom: 8 } }, err), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, style: S.btnS }, "Cancel"), /* @__PURE__ */ React.createElement("button", { onClick: run, disabled: busy, style: { ...S.btnP, background: "#8B5CF6" } }, busy ? "Extracting..." : "Extract with AI"))));
      }
      ...
      function BOMTab({ S, darkMode, projects, bom, setBOM, selProj, costCodes }) {
        ...
        const [showAILine, setShowAILine2] = useState(false);
